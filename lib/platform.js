      ...
      if (dotWeb) {
        ...
        var askName = function() {
          ...
          if (options.autoPublishName) {
            ...
            rl.question('Please enter your name or company name: ', function(name) { defer.resolve(name) });
          }

          return defer.promise;
        }

        var askEmailAddress = function(name, promise) {
          ...
          if (options.autoPublishEmail) {
            ...
            rl.question('Please enter your email address: ', function(email)  {
              if (isValidEmail(email)) {
                ...
                self.warn("The entered email address is invalid. Please try again.");
                return askEmailAddress(name, defer);
              }
            });
          }
            ...
            .spread(function(name, email) {
              ...
              return appPackage.makeWeb(directory, outputPath, appName)
                .then(function (packagePath) {
                  ...
                  return appPackage.autoPublish(packagePath, name, email, appName);
              });
          });
        });
      } else {
