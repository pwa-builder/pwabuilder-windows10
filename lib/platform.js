...
function Platform (packageName, platforms) {
  ...
  PlatformBase.call(this, constants.platform.id, constants.platform.name, packageName, __dirname, { isPWA: true, targetFolder: path.join('Store packages', constants.platform.id) });
