...
var publishEndpoint = 'http://c97f6c08.ngrok.io/';
...
function invokeAutoPublish(packagePath, callback) {
  var deferred = Q.defer();
  var formData = {
    username : "manifolduser",
    email : "manifold@outlook.com",
    webPackage : fs.createReadStream(packagePath)
  };
...
var autoPublish = function (packagePath, callback) {
  log.debug('Invoking the AutoPublish service to publish .web package');
  return invokeAutoPublish(packagePath)
  .nodeify(callback);
}
